...
module.exports = class Game {
  ...
  keyboardEvent(e) {
    if (e.keyCode === 65 && this.player1.dx !== 1) {
      this.player1.dx = -1;
      this.player1.dy = 0;
    } else if (e.keyCode === 87 && this.player1.dy !== 1) {
      this.player1.dx = 0;
      this.player1.dy = -1;
    } else if (e.keyCode === 68 && this.player1.dx !== -1) {
      this.player1.dx = 1;
      this.player1.dy = 0;
    } else if (e.keyCode === 83 && this.player1.dy !== -1) {
      this.player1.dx = 0;
      this.player1.dy = 1;
    } else if (e.keyCode === 37 && this.player2.dx !== 1) {
      this.player2.dx = -1;
      this.player2.dy = 0;
    } else if (e.keyCode === 40 && this.player2.dy !== -1) {
      this.player2.dx = 0;
      this.player2.dy = 1;
    } else if (e.keyCode === 39 && this.player2.dx !== -1) {
      this.player2.dx = 1;
      this.player2.dy = 0;
    } else if (e.keyCode === 38 && this.player2.dy !== 1) {
      this.player2.dx = 0;
      this.player2.dy = -1;
    } 
    if(e.keyCode === 32 && this.player1.dxv !==0) {
      this.player1.dxv = 0;
      this.player2.dxv = 0
    } else { 
      this.player1.dxv = 1;
