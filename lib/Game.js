  ...
  endGame() {  
    ...
    switch(this.keyPressed) {
      case this.player1Score === 3 :
        ...
        this.context.textAlign = tAlign;
        this.context.textBaseline = tBase;
        this.context.fillStyle = tFill[0]; 
        this.context.fillText('GAME OVER! PLAYER 1 WINS', 150, 50); 
      case this.player2Score === 3 :
        ...
        this.context.textAlign = tAlign;
        this.context.textBaseline = tBase;
        this.context.fillStyle = tFill[1]; 
        this.context.fillText('GAME OVER! PLAYER 2 WINS', 150, 50); 
    }
    this.stopped = true;  
  }
