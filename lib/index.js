...
function keyboardEvent(e) {
  if (e.keyCode === 65 && firstBike.dx !== 1 && startGame.keyPress === false) {
    firstBike.dx = -1;
    firstBike.dy = 0;
  } else if (e.keyCode === 87 && firstBike.dy !== 1 && startGame.keyPress === false) {
    firstBike.dx = 0;
    firstBike.dy = -1;
  }  else if (e.keyCode === 68 && firstBike.dx !== -1 && startGame.keyPress === false) {
    firstBike.dx = 1;
    firstBike.dy = 0;
  } else if (e.keyCode === 83 && firstBike.dy !== -1 && startGame.keyPress === false) {
    firstBike.dx = 0;
    firstBike.dy = 1;
  } else if (e.keyCode === 37 && secondBike.dx !== 1 && startGame.keyPress === false) {
    secondBike.dx = -1;
    secondBike.dy = 0;
  }  else if (e.keyCode === 40 && secondBike.dy !== -1 && startGame.keyPress === false) {
    secondBike.dx = 0;
    secondBike.dy = 1;
  }  else if (e.keyCode === 39 && secondBike.dx !== -1 && startGame.keyPress === false) {
    secondBike.dx = 1;
    secondBike.dy = 0;
  }  else if (e.keyCode === 38 && secondBike.dy !== 1 && startGame.keyPress === false) {
    secondBike.dx = 0;
    secondBike.dy = -1;
  } 
  if(e.keyCode === 32) {
