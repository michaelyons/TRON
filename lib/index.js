...
leadingBikeArray.push(leadBike);
var bikeCrash = leadingBikeArray.find((object) => {
  return object === trailArray[0];
});
  ...
  var collide1 = trailArray[0].find(trailx => {return trailx.x === secondBike.x && trailx.y === secondBike.y})
